...
//         setEmail(value);
//         validateForm({ email: value, password });
//     };
...
//                             <h1>Simplify <br />
//                                 management with <br />
//                                 our <span className="highlight">dashboard.<svg xmlns="http://www.w3.org/2000/svg" className="curve" viewBox="0 0 281 15" fill="none">
//                                     <path d="M1.3002 12.7846C54.1335 4.11795 183.6 -8.01538 278.8 12.7846" stroke="white" stroke-width="2.6" stroke-linecap="round" />
//                                 </svg></span>
//                             </h1>
...
//                                         <path fill-rule="evenodd" clip-rule="evenodd" d="M12.2757 13.9315C11.6379 13.9315 11.0019 13.7208 10.4698 13.2994L6.19345 9.85156C5.88547 9.60365 5.8378 9.15265 6.08475 8.84563C6.33361 8.53956 6.78366 8.49093 7.09068 8.73789L11.3633 12.1819C11.9001 12.6071 12.6562 12.6071 13.1968 12.1781L17.4265 8.73979C17.7335 8.48903 18.1836 8.5367 18.4334 8.84372C18.6822 9.14979 18.6355 9.59984 18.3294 9.84965L14.0921 13.2937C13.5563 13.7189 12.9155 13.9315 12.2757 13.9315Z" />
//                                         <path fill-rule="evenodd" clip-rule="evenodd" d="M16.9307 20.1628C16.9326 20.1609 16.9402 20.1628 16.9459 20.1628C18.0339 20.1628 18.9988 19.7738 19.7387 19.0348C20.5978 18.1795 21.0698 16.9505 21.0698 15.5746V9.02605C21.0698 6.36295 19.3287 4.43023 16.9307 4.43023H7.56933C5.1713 4.43023 3.43023 6.36295 3.43023 9.02605V15.5746C3.43023 16.9505 3.90316 18.1795 4.7613 19.0348C5.50121 19.7738 6.46709 20.1628 7.55407 20.1628H16.9307ZM7.55121 21.593C6.07998 21.593 4.76607 21.0591 3.75156 20.0484C2.62167 18.9213 2 17.3328 2 15.5746V9.02605C2 5.59063 4.39421 3 7.56933 3H16.9307C20.1058 3 22.5 5.59063 22.5 9.02605V15.5746C22.5 17.3328 21.8783 18.9213 20.7484 20.0484C19.7349 21.0581 18.42 21.593 16.9459 21.593H7.55121Z" />
//                                     </svg>
//                                 </span>
//                                 <input
//                                     type="email"
...
//                                         <ul>
//                                             <li className={!password || password.length < 8 ? "error" : "success"}>
